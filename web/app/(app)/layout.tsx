...
const loadingLines = [
    "Synchronize was almost called Bonfire before we picked our name. It was meant to be nice and cozy.",
    "Synchronize was almost called Wyvern before we picked our name. Not too proud of that one.",
    "Our logo's name is Clyde.",
    "There are a bunch of hidden 'Easter Eggs' in the app that happen when you click certain things...",
    "Synchronize started as a game company making a mobile game called Fates Forever.",
    "Synchronize’s official birthday is May 13, 2015.",
    "We came up with the idea of Synchronize Nitro over morning breakfast potatoes.",
    "Our mascot, Wumpus, was originally created as a character with no friends :(",
    "In Synchronize's early days, light theme was the only theme. Scary times.",
    "In the ancient days, Synchronize started as a browser-only app.",
    ...
    "Customize Synchronize's appearance in the user settings menu.",
    ...
    "You can drag and drop files onto Synchronize to upload them.",
